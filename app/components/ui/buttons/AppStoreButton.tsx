import { APP_STORE_URL } from "@/app/lib/store-links";
...
export default function AppStoreButton({
  ...
  return (
    ...
    >
      <AppleIcon className="w-[35px] sm:w-[41px] text-[#ffffff] transition-transform duration-300 group-active:scale-105 md:group-hover:scale-110" />
